...
public class DebugHierarchyViewContainer extends ScrollView {
    ...
    private LinearLayout getTitleLayout() {
        ...
        mTitleLayout.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(mContext, "* means not int backBack", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void setView(final List<DebugFragmentRecord> fragmentRecords, final int hierarchy, final TextView tvItem) {
        for (int i = fragmentRecords.size() - 1; i >= 0; i--) {
            DebugFragmentRecord child = fragmentRecords.get(i);
